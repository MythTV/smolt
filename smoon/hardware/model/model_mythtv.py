...
mythtv_host = Table('mythtv_host', metadata,
                     ...
                     Column('vtpertuner', Float,nullable=True),
...
class mythtvHost(object):
    def __init__(self,data,myth_branch,myth_uuid,
                 ...
                 qt_version, channel_count,remote,myth_type,
                 vtpertuner,machine_id):
...
mythtv_logurgency = Table('mythtv_log', metadata,
                        Column('myth_uuid', VARCHAR(36), primary_key=True),
                        Column('crit', Float),
                        Column('info', Float),
                        Column('notice', Float),
                        Column('warning', Float),
                        Column('err', Float),
                        Column('last_modified',
                        DATETIME,default=0, nullable=False))

class mythtvLogUrgency(object):
    def __init__(self,myth_uuid,crit,info,notice,warning,err):
        self.myth_uuid = myth_uuid
        self.crit = crit
        self.info = info
        self.notice = notice
...
mapper(mythtvLogUrgency, mythtv_logurgency)
