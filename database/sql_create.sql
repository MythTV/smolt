...
LOCK TABLES `fas_link` WRITE;
/*!40000 ALTER TABLE `fas_link` DISABLE KEYS */;
/*!40000 ALTER TABLE `fas_link` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `host_links`
--

LOCK TABLES `host_links` WRITE;
/*!40000 ALTER TABLE `host_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `host_links` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2007-12-16 13:17:28
